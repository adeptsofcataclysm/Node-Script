...
**Ведущий** - человек, который совершает основные действия в течении игры. **Ведущим** становится человек, зашедший через /admin URL, и прошедший аутентификацию. 
...
**Зритель** - Видит происходящее без возможности активных действий во время раундов игры. **Зритель** перед проведением `Лотереи` может отказаться от участия. Таким образом отказаться стать **Игроком**. Любой **Зритель** может участвовать в мини-игре `Ставки зрителей`. **Зрителем** становится человек, прошедший страницу ввода имени.
