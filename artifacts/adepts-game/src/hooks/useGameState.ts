...
const DEFAULT_STATE: GameState = {
  ...
  questions: [
    ...
    // Всратый косплей
    [
      { text: "Что изображено на фото?", questionUrl: "/cosplay-100-question.jpg", answerText: "", answerUrl: "/cosplay-100-answer.jpg", used: false },
      { text: "Что изображено на фото?", questionUrl: "/cosplay-200-question.jpg", answerText: "", answerUrl: "/cosplay-200-answer.jpg", used: false },
      { text: "Что изображено на фото?", questionUrl: "/cosplay-300-question.jpg", answerText: "", answerUrl: "/cosplay-300-answer.jpg", used: false },
      { text: "Что изображено на фото?", questionUrl: "/cosplay-400-question.jpg", answerText: "", answerUrl: "/cosplay-400-answer.jpg", used: false },
      { text: "Что изображено на фото?", questionUrl: "/cosplay-500-question.jpg", answerText: "", answerUrl: "/cosplay-500-answer.jpg", used: false },
    ],
    // Халява
    [
