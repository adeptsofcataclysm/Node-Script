  ...
  questions: [
    ...
    [
      {
        ...
        questionUrl: "",
        answerText: "1)К'тун, 2)Скрытень из глубин, 3)Малигос,\n4)Мимирон, 5)Лич кинг(3 фаза), 6)Халион,\n7)Халфий, 8)Гибель Нефариана, 9)Хагара,\n10)Императорский визирь Зор'лок, 11)Гаралон,\n12)Вечные Защитники, 13)Дуруму Позабытый,\n14)Изначалий",
        answerUrl: "",
        used: false,
      },
      {
        text: "",
        questionUrl: "/tactics-200-question.mp4",
      ...
      {
        text: "Перед походом в \"Чёрный Храм\" Адептов просили полететь в Забытый город за семенами колючечника. Для какого босса нужен был этот расходник и как его применяли?",
        questionUrl: "",
    ...
    [
      ...
      },
      {
        ...
        answerUrl: "https://wow.zamimg.com/uploads/screenshots/normal/289826-%D1%81%D1%82%D1%80%D0%B0%D0%BD%D0%BD%D0%B0%D1%8F-%D1%84%D0%B8%D0%B3%D1%83%D1%80%D0%BA%D0%B0-%D0%B2%D0%B5%D1%80%D0%B1%D0%BB%D1%8E%D0%B4%D0%B0.jpg",
        used: false,
      },
    ],
    // НаЯборот
